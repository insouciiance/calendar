...
class Customization extends Component {
    ...
    customizatonTypeButtonClicked = (event, customizationName) => {
        if (this.state.selectedCustomization !== customizationName) {
            ...
            if (
                customizationName === 'presets' &&
                this.props.presetsList.length === 0
            ) {
                    ...
                    <button
                        onClick={() => {
                            if (
                                ...
                                this.currentActiveButton.classList.remove(
                                    classes.active,
                                );
                            }
                            this.setState({
                        ...
                        <ul className={classes.SettingsList}>
                            <li className={classes.Setting}>
                                <button
                                    ...
                                    onClick={event => {
                                        this.customizatonTypeButtonClicked(
                                            event,
                                            'colors',
                                        );
                                    }}>
                    ...
                    <div className={classes.Customizations}>
                        <div
                            ...
                            <div className={classes.ColorCustomization}>
                                <div
                                    className={
                                        classes.ColorCustomizationDescription
                                    }>
                                    <span>Ordinary event color</span>
                                </div>
                                <div
                                    className={
                                        classes.ColorCustomizationPicker
                                    }>
                                    <SketchPicker
                                        color={ordinaryColor}
                        ...
                        <div
                            ...
                            style={{
                                display:
                                    selectedCustomization === 'animations'
                                        ? 'flex'
                                        : 'none',
                            }}>
...
const mapDispatchToProps = dispatch => {
    return {
        setStateCustomizations: customization =>
            dispatch(actions.setCustomizations(customization)),
