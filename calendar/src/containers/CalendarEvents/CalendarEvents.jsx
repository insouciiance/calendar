        ...
        this.timeout = setTimeout(() => {
            ...
            if (scrollDirection > 0) {
                this.props.getEvents(
                    moment(endDate).startOf('day').add(1, 'days'),
                    moment(endDate).startOf('day').add(daysToShow, 'days'),
                );
            } else {
                this.props.getEvents(
                    moment(startDate).startOf('day').add(-daysToShow, 'days'),
                    moment(startDate).startOf('day').add(-1, 'days'),
                );
            }
        ...
        const backdrop =
            tutorialIndex === 2 ? (
                <TutorialBackdrop nextTutorialIndex={3}>
                    ...
                    <p>
                        Here all the events are shown as a simple table with
                        name, time and country of origin
                    </p>
        ...
        const calendarScheduleChartContent = (
            <>
                <div className={classes.CalendarScheduleChartTable}>
                    <div
                        className={classes.CalendarScheduleChartContentWrapper}>
                        <div
                        ...
                        <div
                            className={
                                classes.CalendarScheduleChartEventsContainer
                            }>
                            <div
                                className={
                                    classes.CalendarScheduleChartContentFrames
                                }
                                style={{
                                ...
                                <div
                                    className={
                                        classes.CalendarScheduleChartContent
                                    }>
                                    <CalendarMonths
            ...
            <div
                ...
                <div className={classes.CalendarScheduleChart}>
                    <div className={classes.UpperBar}>
                        <div
                            className={classes.CurrentDateTime}
                            ref={this.CurrentDateTimeDOM}>
...
const mapDispatchToProps = dispatch => {
    return {
        getEvents: (startDate, endDate, includePassedEvents) =>
            dispatch(
                actions.getEventsThunk(startDate, endDate, includePassedEvents),
            ),
        setSelectedElementIndex: index =>
            dispatch(actions.setSelectedElementIndex(index)),
