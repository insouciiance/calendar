...
class CalendarEventsDetails extends Component {
    ...
    componentDidMount() {
        this.DistanceBarDOM.current.style.width = `${
            ((this.props.selectedElementIndex + 1) /
    ...
    componentDidUpdate(prevProps) {
        ...
        if (
            this.props.selectedElementIndex !== prevProps.selectedElementIndex
        ) {
            if (prevProps.eventsList !== this.props.eventsList) {
                ...
                const supposedLeftDistance =
                    ...
                    35 -
                    (this.CalendarEventsDetailsInnerDOM.current.clientWidth /
                        2 -
                        120);

                this.leftDistance =
                    supposedLeftDistance >= 0 ? supposedLeftDistance : 0;
            }
    ...
    onLeftPointerClickHandler = () => {
        if (this.leftDistance >= this.scrollAmount) {
            this.CalendarEventsDetailsInnerFlexDOM.current.style.transform = `translateX(-${
                this.leftDistance - this.scrollAmount
            }px)`;

            this.leftDistance -= this.scrollAmount;
        } else {
            this.CalendarEventsDetailsInnerFlexDOM.current.style.transform =
                'translateX(0)';
            this.leftDistance = 0;
        }
    ...
    onRightPointerClickHandler = () => {
        if (
            this.leftDistance <
            this.CalendarEventsDetailsInnerFlexDOM.current.clientWidth -
                this.scrollAmount * 2
        ) {
            this.CalendarEventsDetailsInnerFlexDOM.current.style.transform = `translateX(-${
                this.leftDistance + this.scrollAmount
        ...
        const backdrop =
            tutorialIndex === 4 ? (
                <TutorialBackdrop nextTutorialIndex={5}>
                    <p>
                        Here all the events that are shown in the event table
                        are listed
                    </p>
        ...
        return (
            <div
                ...
                <div
                    ...
                    onClick={this.onLeftPointerClickHandler}>
                    &#8249;
                </div>
                <div
                    ...
                    style={{
                        transition: `${this.props.customization.bottomPanelScrollSpeed}ms`,
                    }}>
                ...
                <div
                    ...
                    onClick={this.onRightPointerClickHandler}>
                    &#8250;
                </div>
                <div
                    ...
                    style={{
                        ...
                        width: `${
                            ((selectedElementIndex + 1) / eventsList.length) *
                            100
                        }%`,
                    }}
                />
...
export default connect(mapStateToProps, null)(CalendarEventsDetails);
