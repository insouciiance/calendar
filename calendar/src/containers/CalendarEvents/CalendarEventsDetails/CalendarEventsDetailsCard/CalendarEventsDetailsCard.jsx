...
const CalendarEventDetailsCard = props => {
	...
	const millisecondsLeft = moment.duration(moment(date).diff(moment()), 'milliseconds');
	const timeLeftHumanized = millisecondsLeft > 0 ? millisecondsLeft.humanize() : 'Finished';
	...
	return (
		<div className={wrapperClasses} onClick={() => onSelectElementHandler(index)}>
...
const mapDispatchToProps = dispatch => {
	return {
		onSelectElementHandler: index => dispatch(setSelectedElementIndex(index))
	};
};
